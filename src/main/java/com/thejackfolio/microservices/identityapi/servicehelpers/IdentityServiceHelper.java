...
public class IdentityServiceHelper {
    ...
    public ClientCredential saveClientCredential(ClientCredential credential) throws DataBaseOperationException, MapperException, ValidationException, EmailException {
        ...
        } else if(responseBody.getMessage().equals(StringConstants.EMAIL_EXIST)) {
